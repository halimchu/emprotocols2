      ...
      <SafeAreaView style={styles.container}>
        <ScrollView>
                ...
                <View style={styles.top}>
                  ...
                  <View style={{marginTop: Dimensions.get('window').height/50,}}>
                    <Text style={styles.text}>
                      This EMP Application Privacy Policy, along with the EMP Terms of Use will tell you what information we collect through EMP and how it is used. By using the EMP, you agree to acceptance of this Application Privacy Policy.
                    </Text>
                  </View>
                ...
                <View style={{alignItems: 'center', marginTop: Dimensions.get('window').height/60,}}>
                  ...
                  <Text style={styles.text}>Some sections of the EMP website may require login identifiers and/or passwords. You are responsible for taking reasonable steps to ensure that no unauthorized person has access to your password or account login information. It is your sole responsibility to control the use of login information and passwords, to authorize, monitor and control access to and use of your account and password and to inform EMP promptly of any need to deactivate a password.</Text>
