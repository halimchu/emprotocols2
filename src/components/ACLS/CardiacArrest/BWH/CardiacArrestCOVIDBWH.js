...
export default class CardiacArrestCOVIDBWH extends React.Component {
  ...
  constructor(props) {
    ...
    // this.ImageURI = require('../../../../assets/CardiacArrestCOVID3000x2500.png')
  }
  ...
  <View style={{alignItems: 'center',}}>
    ...
    <View style={{
      ...
      <View style={{flexDirection: 'row', marginTop: Dimensions.get('window').height/140, }}>
          <Text style={{
