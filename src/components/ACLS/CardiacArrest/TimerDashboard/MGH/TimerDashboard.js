...
import { AppState, Image, Dimensions, View, Text, StyleSheet, TouchableOpacity, ActionSheetIOS } from 'react-native'
...
let incrementCPR
let incrementEPI
export {incrementCPR, incrementEPI}
...
class TimerDashboard extends React.Component {
  ...
  startTimerCPR = () => {
    ...
    return (dispatch) => {
      ...
      minuteCPR = 0
                          ...
                          clearInterval(incrementCPR)
                          incrementCPR = setInterval( () => dispatch({ 
                            type: 'START_TIMER_CPR', 
                            timerTextColor: timerTextColor(),  
                            incrementType: incrementCPR, 
                            min: min(), 
                            sec: sec(), 
                            buttonStatusNumberCPR: '1',  
  ...
  startTimerEPI = () => {
    ...
    return (dispatch) => {
                            ...
                            clearInterval(incrementEPI)
                            incrementEPI = setInterval( () => dispatch({ 
                              type: 'START_TIMER_EPI', 
                              timerTextColor: timerTextColor(),  
                              incrementType: incrementEPI, 
                              min: min(), 
                              sec: sec(), 
...
const mapStateToProps = (state) => {
  return {
    timerTextColorCPR: state.timerReducerCPR.timerTextColor,
    minuteCPR: state.timerReducerCPR.minute,
    secondCPR: state.timerReducerCPR.second,
    buttonStatusNumberCPR: state.timerReducerCPR.buttonStatusNumberCPR,
    resetAllCPR: state.timerReducerCPR.resetAllCPR,

    timerTextColorEPI: state.timerReducerEPI.timerTextColor,
    minuteEPI: state.timerReducerEPI.minute,
    secondEPI: state.timerReducerEPI.second,
    buttonStatusNumberEPI: state.timerReducerEPI.buttonStatusNumberEPI,
    resetAllEPI: state.timerReducerEPI.resetAllEPI,

    CPR: state.buttonsReducer.CPR,
    epi: state.buttonsReducer.epi,
    shock: state.buttonsReducer.shock,
    firstClick: state.buttonsReducer.firstClick,
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(TimerDashboard)
